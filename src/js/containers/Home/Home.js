...
const Home = () => {
    ...
    const { data, isFetching, isFetched, error, refetch } = useCurrentRouteData();
    console.log('Current route data:', { data, isFetching, isFetched, error });
    ...
    const filteredExpenses = useMemo(() => {
        ...
        return state.selectedCategory === 'all' 
            ? expenses 
            : expenses.filter(exp => exp.category === state.selectedCategory);
    }, [expenses, state.selectedCategory]);
            ...
            {isFetching ? (
                ...
                <>
                    <div className="summary">
                        <h2>Total Expenses: {formatAmount(totalAmount)}</h2>
                        <select 
